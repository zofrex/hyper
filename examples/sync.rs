...
pub struct Request<'a> {
    ...
    ctrl: &'a hyper::http::Control,
}

impl<'a> Request<'a> {
    fn new(inner: hyper::server::Request, tx: &'a mpsc::Sender<Action>, rx: &'a mpsc::Receiver<io::Result<usize>>, ctrl: &'a hyper::http::Control) -> Request<'a> {
        Request {
            inner: inner,
            tx: tx,
            rx: rx,
...
impl<'a> Response<'a, Fresh> {
    fn new(tx: &'a mpsc::Sender<Action>, rx: &'a mpsc::Receiver<io::Result<usize>>, ctrl: &'a hyper::http::Control) -> Response<'a, Fresh> {
        Response {
            status: hyper::Ok,
...
impl hyper::server::Handler<hyper::net::HttpStream> for SynchronousHandler {
    ...
    fn on_request_readable(&mut self, decoder: &mut hyper::http::Decoder<hyper::net::HttpStream>) -> hyper::Next {
    ...
    fn on_response_writable(&mut self, encoder: &mut hyper::http::Encoder<hyper::net::HttpStream>) -> hyper::Next {
